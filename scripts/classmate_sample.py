...
def main():
    ...
    parser.add_argument('--allow-partial', action='store_true', help='Use the accepted partial dataset')
    ...
    table = load_month_sample(args.year, args.month, dataset=args.dataset, profile=args.profile,
                             limit=args.limit, max_download_mib=args.max_download_mib, allow_partial=args.allow_partial)
